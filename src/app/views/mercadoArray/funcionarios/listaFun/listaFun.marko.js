...
function render(input, out, __component, component, state) {
  ...
  marko_forOf(data.funcionarios, function(itemFun) {
    ...
    out.w("<tr" +
      marko_attr("id", "funcionario_" + itemFun.id) +
      "><td scope=row>" +
